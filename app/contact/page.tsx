...
export default function ContactPage() {
  return (
    <>
      ...
      />
      <section className="container-pad grid gap-10 py-14 sm:py-20 lg:grid-cols-[0.9fr_1.1fr]">
        <Reveal>
          <SectionHeader
            title="School office"
          ...
          />
          <dl className="mt-8 grid gap-5 rounded-2xl border border-forest-900/10 bg-white p-6 shadow-sm">
            <div>
        ...
        <Reveal className="rounded-2xl border border-forest-900/10 bg-white p-6 shadow-lift">
          ...
          <ul className="mt-6 grid gap-4">
            {[
              ...
              <li
                className="rounded-xl border border-forest-900/10 bg-earth-50 p-4 text-sm font-semibold leading-6 text-forest-900/78"
                key={item}
              >
                {item}
              </li>
          ...
          <a
            className="focus-ring mt-6 inline-flex rounded-md bg-forest-800 px-5 py-3 text-sm font-black text-white transition hover:-translate-y-0.5 hover:bg-forest-900"
